      ...
      <section className="">
        <div className="px-5  py-[.8rem] bg-gray-700 lg:px-20 lg:py-2 flex  justify-between h-16 w-full border-b-2 border-gray-600 text-white">
          ...
          <div className="hidden sm:block w-full ">
            <div className="search_bar   items-center w-full p-1  ">
              <span className="search_icon">
                {" "}
                <IoSearch className="text-[25px] bg-white text-gray-700   p-1" />
              </span>
              <input
                type="text"
          ...
          <div className="flex items-center space-x-2 lg:space-x-2 justify-evenly">
            <div className=" px-2">
              <a href="" className="text-white  rounded-full p-1">
        ...
        <div className="px-5  py-[.8rem] bg-gray-700 lg:px-20 lg:py-2 flex  justify-between h-16 w-full border-b-2 border-gray-600 text-white sm:hidden">
          <div className="search_bar   items-center w-full p-1  ">
            <span className="search_icon">
              {" "}
              <IoSearch className="text-[25px] bg-white text-gray-700   p-1" />
